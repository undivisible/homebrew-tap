class Inauguration < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tschk/inauguration/releases/download/v0.6.7/in-macos-aarch64.tar.gz"
      sha256 "placeholder"
    end
  end
  ...
  on_linux do
    on_x86_64 do
      url "https://github.com/tschk/inauguration/releases/download/v0.6.7/in-linux-x86_64.tar.gz"
      sha256 "placeholder"
    end
  end
