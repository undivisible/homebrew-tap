class Tk < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/tschk/telekinesis/releases/download/v0.5.9/tk-aarch64-apple-darwin.tar.gz"
      sha256 "6af3b25a73b42e15249428f5f20359e39060e401a98e85ff2cdfa9898af9bf17"
    end
    on_intel do
      url "https://github.com/tschk/telekinesis/releases/download/v0.5.9/tk-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/tschk/telekinesis/releases/download/v0.5.9/tk-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "148741fb75b144a35535852f63c246126d51774574d02ceac1535f7b9159bd12"
    end
    on_intel do
      url "https://github.com/tschk/telekinesis/releases/download/v0.5.9/tk-x86_64-unknown-linux-gnu.tar.gz"
