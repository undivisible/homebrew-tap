class HerdrGui < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/undivisible/herdr-gui/releases/download/v0.1.10/herdr-gui-macos-aarch64.tar.gz"
      sha256 "182ddf5c2f33ec9b759ae482c45da8023b85cdc705bf8944afb9739c22958d34"
    end
  end
